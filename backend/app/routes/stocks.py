...
#     "Consumer": ["AMZN", "COST", "WMT", "HD", "NKE"],
#     "Industrial": ["CAT", "BA", "GE", "HON", "UNP"],
#     "Real Estate": ["PLD", "AMT", "O", "SPG", "CCI"],
# }

# GOAL_PREFERENCE_HINTS = {
#     "Learning": (
#         "These stocks are widely followed and useful for learning how price action, "
#         "sentiment, and indicators work together."
#     ),
#     "Long Term Growth": (
#         "These stocks are selected to align with a growth-focused preference and can "
#         "be monitored for longer-term upside potential."
#     ),
#     "Income": (
#         "These stocks can be used as starting ideas for users who prefer more "
#         "established companies and potentially steadier profiles."
#     ),
#     "Short Term Trading": (
#         "These stocks are suitable for active monitoring with technical indicators, "
#         "momentum, and short-term sentiment changes."
#     ),
# }
...
#         for ticker in SECTOR_TICKER_MAP.get(sector, []):
...
#                 "reason": f"Suggested from your preferred sector: {sector}.",
#             })
#         except Exception:
#             enriched.append({
#                 "ticker": ticker,
...
#             goal,
#             "These stocks are selected based on your saved investor preferences."
#         ),
#         "items": enriched,
#     })
...
def recommendations(user_id: int):
    ...
    final_items = ranked_items[:_output_limit(risk_tolerance)]
